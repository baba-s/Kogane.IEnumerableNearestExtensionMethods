...
namespace Kogane
{
    ...
    public static class IEnumerableNearestExtensionMethods
    {
        ...
        {
            var min = self.Min( x => Math.Abs( x - target ) );
            return self.FirstOrDefault( x => Math.Abs( x - target ) == min );
        }
        ...
        {
            var min = self.Min( x => Math.Abs( selector( x ) - target ) );
            return selector( self.FirstOrDefault( x => Math.Abs( selector( x ) - target ) == min ) );
        }
        ...
        {
            var min = self.Min( x => Math.Abs( selector( x ) - target ) );
            return self.FirstOrDefault( x => Math.Abs( selector( x ) - target ) == min );
        }
